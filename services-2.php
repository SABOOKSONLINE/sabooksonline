						...
						<div class="filter_type">
							...
							<div class="collapse " id="filter_1">
								<ul>
								    ...
								    <li>
								        <label class="container_radio">KwaZulu-Natal
								     ...
								     <li>
								        <label class="container_radio">Limpopo
								            <input type="checkbox" id="province2" name="filter_sort" value="LP">
								            <span class="checkmark"></span>
								        </label>
								    </li>
								    <li>
								        <label class="container_radio">Eastern Cape
                                    ...
                                    <li>
								        <label class="container_radio">Northern Cape
								            <input type="checkbox" id="province4" name="filter_sort" value="NC">
								            <span class="checkmark"></span>
								        </label>
								    </li>
								    <li>
								        <label class="container_radio">North West
								     ...
								     <li>
								        <label class="container_radio">Western Cape
								            <input type="checkbox" id="province6" name="filter_sort" value="WC">
								            <span class="checkmark"></span>
								        </label>
								    </li>
								    <li>
								        <label class="container_radio">Mpumalanga
                                    ...
                                    <li>
								        <label class="container_radio">Gauteng
								            <input type="checkbox" id="province8" name="filter_sort" value="GP">
								            <span class="checkmark"></span>
								        </label>
								    </li>
								    <li>
								        <label class="container_radio">Free State
