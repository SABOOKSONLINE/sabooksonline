...
<body id="register_bg">
	...
	<div id="register">
		<aside>
			<figure>
				<a href="https://sabooksonline.co.za/"><img src="img/social.png" width="140" height="55" alt=""></a>
			</figure>
			<div class="access_social">
					<h4 class="text-center">Forgot Password</h4>
				</div>
                
				<div class="text-center mt-2"><small>You need to provide your account email address to continue with the password reset. <strong><a href="how-to-reset-password">See Reset Guide</a></strong></small></div>
...
<script src="js/custom.js"></script>
	...
	<script>
        ...
        $.ajax({
                url: "includes/backend/reset.php",
            type: "POST",
