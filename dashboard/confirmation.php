        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            <div class="order_complete_message text-center">
              ...
              <h2 class="title">You have successfully switched your account.</h2>
              <p class="text">Thank you. Your order has been completed.</p>
            </div>
          </div>
        </div>

        <?php
        $formattedValue = number_format($totalPrice, 2) + 5;


        $amount = 3000;
        $invoice = '445433';
        $invoiceNumber = '445433';
