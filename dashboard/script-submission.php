              ...
              <div class="col-xl-12">
                ...
                <div class="ps-widget bgc-white bdrs12 p30 mb30 overflow-hidden position-relative">
                  <div class="bdrb1 pb15 mb30">
                    <h5 class="list-title">Manuscript Book Details</h5>
                  </div>
                  <div class="row">
                ...
                <div class="ps-widget bgc-white bdrs12 p30 mb30 overflow-hidden position-relative">
                  <div class="bdrb1 pb15 mb30">
                    <h5 class="list-title">Manuscript File</h5>
                  </div>
                  <div class="row">
                ...
                <div class="col-6 col-xl-2">
                    ...
                    <div class="profile-content ml20 ml0-xs">
                         <div class="d-flex align-items-center my-3">
                            <!-- <a href="#" class="tag-delt text-thm2"><span class="flaticon-delete text-thm2"></span></a>-->
                            <a href="#" class="upload-btn ml10"> 
                              <input type="file" name="pdf" id="mp3" accept="application/pdf">
                            </a>
                        </div>
                    </div>
...
$(document).ready(function() {
	...
	$("#upload-book").on('submit',(function(e) {
		...
		$.ajax({
			url: "../includes/backend/submissions/manuscript_submission.php",
			type: "POST",
			data: formData,
			contentType: false,
				cache: false,
