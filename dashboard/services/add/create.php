        ...
        <div class="dashboard__content hover-bgc-color">
          ...
          <div class="breadcumb-section pt-0">
            <div class="cta-employee-single cta-banner mx-auto maxw1700 pt120 pt60-sm pb120 pb60-sm bdrs16 position-relative d-flex align-items-center">
                ...
                <div class="row wow fadeInUp">
                    ...
                    <div class="position-relative">
                        <h2>Your domain is <b><?php echo $_GET['domain'].'.'.$_GET['tld'];?></b></h2>
                    ...
                    <div class="advance-search-tab bgc-white p10 bdrs4 mt30">
                        <div class="row">
                            <div class="col-md-3 col-lg-2 col-xl-6">
                                ...
                                <a class="ud-btn btn-thm2 w-100 vam"  href="https://sabooksonline.co.za/how-to-register-payfast-updated.php" target="_blank">How to Create A PayFast Account</a>
                                </div>
                            </div>

                            <div class="col-md-3 col-lg-2 col-xl-6">
                                <div class="text-center text-xl-start">
                                <a class="ud-btn btn-thm2 w-100 vam" href="https://registration.payfast.io/" target="_blank">Create PayFast Account</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            if($_GET['type'] == 'sub'){
                ...
                echo '<input type="text" class="form-control d-none" name="merchant_id" value="service-locked" required>
                       <input type="text" class="form-control d-none"" name="merchant_key" value="service-locked" required>
                        ';
               
            } else {
                echo '<div class="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" name="merchant_id" required>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">PayFast Merchant Key</label>
                          <input type="text" class="form-control" name="merchant_key" required>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Passphrase</label>
                          <input type="text" class="form-control" name="passphrase" required>
                        </div>
                      </div>
          ...
          <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" name="number" value="<?php  echo $_SESSION['ADMIN_NUMBER']?>"required>
                          ...
                          <input type="hidden" class="form-control" name="domain" value="<?php echo $_GET['domain']?>"required>
                          <input type="hidden" class="form-control" name="tld" value="<?php echo $_GET['tld']?>"required>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Email Address</label>
                          <input type="text" class="form-control" name="email" value="<?php  echo $_SESSION['ADMIN_EMAIL']?>" readonly required>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-12">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" name="address" value="<?php  echo $_SESSION['ADMIN_GOOGLE']?>" required>
                        </div>
                      </div>
                ...
                <div class="col-lg-12">
                  <div class="form-style1">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Standard Shipping Fee (R) <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="right" title="Set your standard shipping fee in rands."></i></label>
                          <input type="number" class="form-control" name="shipping" placeholder="R195" value="0" required>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="number" class="form-control" name="shipping" placeholder="R195" value="" required>
                        </div>
                      </div>
            ...
            ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="mb10">
                          ...
                          <textarea cols="30" rows="6" name="desc" required><?php  echo $_SESSION['ADMIN_BIO']?></textarea>
                        </div>
                      </div>
              ...
              <div class="ps-widget bgc-white bdrs12 p30 mb30 overflow-hidden position-relative d-none">
                <div class="bdrb1 pb15 mb25">
                  <h5 class="list-title">Choose which books to show on the website</h5>
                </div>
                <div class="col-xl-12">
            ...
            <?php
								...
								if(!$result = mysqli_query($conn, $sql)){
									...
									while($row = mysqli_fetch_assoc($result)) {
											...
											echo '<div class="extra-service-tab">
                      <nav>
                        <div class="nav flex-column nav-tabs" id="nav-tab" role="tablist">
                          <button class="nav-link active" id="nav-home2-tab" data-bs-toggle="tab" data-bs-target="#nav-home2" type="button" role="tab" aria-selected="true">
                            <label class="custom_checkbox fw500 text-start">'.ucwords($row['TITLE']).'
                              <span class="text text-bottom">'.substr(strtolower($row['DESCRIPTION']), 0, 205).'</span>
                              <input type="checkbox" checked="checked">
                              <span class="checkmark"></span>
                            </label>
                            <span class="price"><img src="https://sabooksonline.co.za/cms-data/book-covers/'.$row['COVER'].'" width="35px"></span>
              ...
              <div class="text-lg-start">
                <button type="submit" class="ud-btn btn-dark default-box-shadow2" id="reg_load">Publish Website<i class="fal fa-arrow-right-long"></i></button>
...
<script>
      ...
      $("#submit").on('submit',(function(e) {
        ...
        $("#reg_load").html('<div><div class="spinner-border text-light" role="status"> <span class="sr-only">Loading...</span> </div> Please wait...This process might take 90 Seconds.</div> ');
