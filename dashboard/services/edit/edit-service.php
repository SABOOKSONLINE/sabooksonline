...
<?php
                                 ...
                                 $sql = "SELECT * FROM services WHERE ID = '$contentid'";
                        ...
                        <div class="mb20">
                          <div class="form-style1">
                            ...
                            <div class="bootselect-multiselect">
                                  ...
                                  <option value="<?php echo $service;?>"><?php echo $service;?> - Current</option>
                            ...
                            <div class="range-slider-style1 mb-4 mb-lg-5">
                              <div class="range-wrapper">
                                ...
                                <div class="text-center">
                                  ...
                                  <input type="text" class="amount" value="<?php echo $min;?>" name="service_price_min"><span class="fa-sharp fa-solid fa-minus mx-2 dark-color"></span>
                                  <input type="text" class="amount2" name="service_price_max" value="<?php echo $max;?>">
                                  <input type="hidden" class="amount2" name="service_id" value="<?php echo $id;?>">
                                </div>
                              </div>
                            </div>
                          </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    $(document).ready(function() {
        ...
        $("#membership").on('submit',(function(e) {
            ...
            $.ajax({
                    url: "../includes/backend/member-add-service-update.php",
                type: "POST",
