<?php
			...
			$user = str_replace('-',' ', $_GET['provider']);
			$user = str_replace('_',' ', $_GET['provider']);

			include 'includes/database_connections/sabooks.php';
            $sql = "SELECT * FROM users WHERE USER_STATUS = 'Verified' AND ADMIN_ID = '$user'";
            ...
            if(mysqli_num_rows($result) == false){
                ...
                while($row = mysqli_fetch_assoc($result)) {
					...
					$type = str_replace('-', ' ', ucfirst($row['ADMIN_TYPE']));
					$bio = $row['ADMIN_BIO'];
                    ...
                    $type =  '<li><a href="#0">'.str_replace(',','</a></li><li><a href="#">', $row['ADMIN_SERVICES']).'</a></li>';
                    }
                }
...
<head>
    ...
    <link rel="canonical" href="https://sabooksonline.co.za/provider?q=<?php echo $name;?>"/>
    ...
    <meta property="og:url"            content="https://sabooksonline.co.za/creator?q=<?php echo $name;?>" />
...
<body data-spy="scroll" data-bs-target="#secondary_nav" data-offset="75">
	...
	<main>
        ...
        <br>
        <br>
	    <div class="container margin_detail_2 mt-5 pt-5">
	        <div class="row">
	            <div class="col-lg-8">
	                <div class="detail_page_head clearfix">
	                    <div class="rating">
	                        <div class="score"><span>Based On<em><?php 
                            $rows_query = mysqli_query($conn, "SELECT COUNT(*) as number_rows FROM reviews WHERE USERKEY = '$userkey'");
	                    ...
	                    <div class="title d-flex justify-content-start">
							<img src="<?php echo $cover;?>" style="width: 100px;height: 100px;margin-right:5%;background:#f3f3f3;border: #eee solid 3px;padding:1%;border-radius:10px;">
							<div>
								<h1><?php echo $name;?></h1>
								...
								<ul class="tags">
                                    <?php
                                        ...
                                        $sqls = "SELECT * FROM services WHERE USERID = '$userkey'";
                                        $results = mysqli_query($conn, $sqls);
                                        if(mysqli_num_rows($results) == false){
                                        }else{
                                            while($rows = mysqli_fetch_assoc($results)) {

                                                echo '<li><a href="#0">'.$rows['SERVICE'].'</a></li>';
	            ...
	            <div class="col-lg-4">
					...
					<?php 
						...
						include 'includes/database_connections/sabooks.php';
						$sql = "SELECT * FROM provider_images WHERE PROVIDER_KEY = '$userkey' LIMIT 6";
						...
						$result = mysqli_query($conn, $sql);
							...
							while($row = mysqli_fetch_assoc($result)) {
								...
								echo ' <figure>
								<a href="https://sabooksonline.co.za/cms-data/user-images/'.$row['PROVIDER_IMAGE'].'" title="Photo title" data-effect="mfp-zoom-in">
									<img src="https://my.sabooksonline.co.za/cms-data/user-images/'.$row['PROVIDER_IMAGE'].'" data-src="https://my.sabooksonline.co.za/cms-data/user-images/'.$row['PROVIDER_IMAGE'].'" class="lazy" alt="">
								</a>
							</figure>';
							}
						}
	            ...
	            <div class="row">
                    ...
                    <hr>
						...
						<?php
							...
							include 'includes/database_connections/sabooks.php';
							$sqls = "SELECT * FROM reviews WHERE STATUS = 'active' AND USERKEY = '$userkey' ORDER BY ID DESC";
							$results = mysqli_query($conn, $sqls);
							if(mysqli_num_rows($results) == false){
								...
								while($rows = mysqli_fetch_assoc($results)) {
                                    ...
                                    $review_btn = '<div class="text-end menu_item modal_dialog" href="#modal-dialog"><a href="#" class="btn_1 gradient">Add a review</a></div>';
