...
<nav class="navbar navbar-expand-xl navbar-light fixed-top border-bottom bg-white">
    <div class="container-fluid">
        ...
        <a href="/dashboards" class="btn btn-outline-dark btn-sm ms-3 d-none d-xl-inline-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <a href="/dashboards" class="btn btn-outline-dark btn-sm ms-3 d-xl-none mb-2">
                <i class="fas fa-arrow-left me-2"></i>Back to Dashboard
            </a>
