            ...
            <ol class="breadcrumb">
              ...
              <div class="box_general padding_bottom col-md-6">
                <div class="header_box version_2">
                    <h2><i class="fa fa-list"></i>Show products by Brand Name</h2>
                </div>
                ...
                <!-- /.container-wrapper-->
                <p><button class="btn_1 medium btn-danger" type="submit">Show products</button></p>
              ...
              <div class="box_general padding_bottom col-md-6">
                <div class="header_box version_2">
                    <h2><i class="fa fa-list"></i>Show products by Category Name</h2>
                </div>
                <div class="wrapper_indent">
