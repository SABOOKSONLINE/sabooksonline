    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Active Events</li>
            </ol>
        ...
        include 'includes/database_connections/sabooks.php';
                                        $sql = "SELECT * FROM events WHERE CURRENT = 'Active' ORDER BY ID DESC;";
                                       if($result = mysqli_query($conn, $sql)){
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo ' <li>
                                                    ...
                                                    <p><a href="includes/backend/hide/event.php?contentid='.$row['CONTENTID'].'" class="btn_1 gray"><i class="fa fa-fw fa-close"></i> hide item </a>   <a href="edit-event.php?contentid='.$row['CONTENTID'].'" class="btn_1 gray"><i class="fa fa-fw fa-edit"></i> Edit listing</a></p>
                                                    <ul class="buttons">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a class="btn btn-danger" href="includes/backend/delete/event.php?contentid='.$row['CONTENTID'].'&page=event-listings">Confirm</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                             </div>';
                                        ...
                                        echo "<p class='text-warning'>No content has been Activated <b>Yet!</b>!</p><br>";
                                       }
