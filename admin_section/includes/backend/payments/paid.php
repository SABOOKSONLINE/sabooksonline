<?php
            ...
            //VARIABLES DECLARED
									...
									if(mysqli_num_rows($result) == false){
										...
										$subject = "Payment confirmation for #".$number;

                                        $not_type = "Paid";
                    
                                        include '../templates/emails/multiuse.php';

                                        $sql = "INSERT INTO notifications ( USERKEY, MESSAGE , TYPE) VALUES ( '$userkey','$message' , '$not_type' );";
											
											if(!mysqli_query($conn, $sql)){
												
												header("Location: ../../../subscription.php?status1=failed");
												
											}else{

                                                $sql = "UPDATE invoices SET INVOICE_STATUS = 'Paid' WHERE INVOICE_NUMBER = '$contentid'";
												...
												header("Location: ../../../subscriptions.php?status1=success");
