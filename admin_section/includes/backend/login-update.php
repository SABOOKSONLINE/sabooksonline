...
// Start the session
  ...
  $log_email = mysqli_real_escape_string($conn, $_GET['log_email']);
  $log_pwd2 = mysqli_real_escape_string($conn, $_GET['log_password']);
        ...
        if(!mysqli_num_rows(mysqli_query($conn, $sql))){
          ...
          if(!password_verify($log_pwd2, $dehash)){
            ...
            /*start the sessions*/
                ...
                header("Location: https://my.sabooksonline.co.za/dash/dashboardmyprofile.php");
