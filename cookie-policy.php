<?php
 ...
 function logPageVisit($conn, $page_url, $user_agent, $referer, $duration, $user_province, $user_ip) {
    $current_time = date('Y-m-d H:i:s');

    $stmt = $conn->prepare("INSERT INTO page_visits (page_url, user_agent, referer, visit_time, duration, user_country, user_ip) VALUES (?, ?, ?, ?, ?, ?, ?)");
    
    // Bind values to the prepared statement
    $stmt->bind_param("sssssss", $page_url, $user_agent, $referer, $current_time, $duration, $user_country, $user_ip);
...
// Make an API request to get the user's country using ipstack
$ipstack_api_key = '7b935797110b303487a4899a5f3316ef';
$api_url = "http://api.ipstack.com/$user_ip?access_key=$ipstack_api_key";
$response = file_get_contents($api_url);
$geolocation_data = json_decode($response);
$user_country = $geolocation_data->country_name;

$user_country = $geolocation_data->country_name;
$user_province = isset($geolocation_data->region_name) ? $geolocation_data->region_name : 'Unknown';

// Log the visit
logPageVisit($conn, $page_url, $user_agent, $referer, $duration, $user_province, $user_ip);
...
<head>
    ...
    <meta name="keywords" content="SA Books Online | The Gateway To South African Literature | Cookie Policy">
    <meta name="author" content="SA Books Online">
    <title>SA Books Online | Cookie Policy</title>
...
<!-- Global site tag (gtag.js) - Google Analytics -->
	...
	<style>#cp a, #cp i {color: #e54750 !important;}</style>
		...
		<div class="page_header pt-5">
			...
			<hr>
		    	<div class="row">
					...
					<h1>Cookie Policy</h1>
						<p><small><a href="index"><i class="icon_house_alt"></i> Home</a> - <a href="#">Documentation</a> - Cookie Policy</small></p>
		    		</div>
			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="row shift-dots">
						<div class="col-12"><h2 class="">Cookie Policy - Disclaimers</h2></div>
