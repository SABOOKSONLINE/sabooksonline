...
<!-- Global site tag (gtag.js) - Google Analytics -->
	...
	<style>
		.google {
			background-image: url('img/Google__G__Logo.svg') !important;
	...
	<div id="register">
		<aside>
			...
			<div class="access_social">
					...
					<a href="<?php echo $authUrl; ?>" class="social_bt google" style="background: #fff !important;border: #ddd 1px solid;color: #444;"><img src="img/Google__G__Logo.svg" width="20px" class="mr-5"> Login with Google</a>
				</div>
			...
			<form autocomplete="off" id="login">
				...
				<div class="form-group">
					<input class="form-control" type="email" placeholder="Email" name="log_email" value="<?php echo $e;?>" required>
					<i class="icon_mail_alt"></i>
				</div>
				<div class="form-group">
					<input class="form-control" type="password" id="password" placeholder="Password" name="log_pwd2" value="<?php echo $p;?>" required>
