	        ...
	        <div class="row row-height">
	            <div class="content-left order-md-last order-sm-last order-last map_view">
	                <div class="page_header">
	                    <div class="row">
	                        <div class="col-xl-12 d-none d-md-block pt-4">
	                            <h1>Book Stores</h1>
	                        </div>
	                        <div class="col-xl-12">
	                            <div class="search_bar_list">
                                    <form id="search">
                                        <input type="text" class="form-control" placeholder="Search for book stores" name="service">
...
<script>
    ...
    $('#side-search').keyup(function (){
        ...
        $('#demo').load('includes/book-store.php');
