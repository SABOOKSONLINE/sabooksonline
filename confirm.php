...
<head>
    ...
    <title>Confirmation | SA Books Online</title>
		        	...
		        	<div class="box_order_form">
		                ...
		                <div class="main">
		                	<div id="confirm">
								...
								<p>An Email has been sent your mailbox <b class="text-info"><?php echo $_GET['email'];?></b>, please check your inbox for a verification link. <b>If you cannot find the email please check your SPAM.</b></p>
							</div>
		                </div>
		            </div>
		            <!-- /box_booking -->
