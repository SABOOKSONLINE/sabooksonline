...
<head>
    ...
    <title>privacy policy | SA Books Online</title>
			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="row shift-dots">
						<div class="col-12"><h2 class="">Private Policy</h2></div>
						<div class="container"><hr></div>

						<h6><b>1.</b> Introduction</h6>
						
						
							<p>Welcome to SA Books Online ("we," "us," or "our"). This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you visit our website www.sabooksonline.co.za (the "Site"). Please read this Privacy Policy carefully</p>
						

						<div class="mt-5"  style="background: #f3f3f3;padding:5%;border-radius: 10px !important;">

							<h6><b>2. </b>Information We Collect</h6>
							<ul>
								<li>Personal Information: We may collect personal information, such as your name, email address, and other contact details when you voluntarily provide it to us. 
									
								<li>Usage Data: We may collect information about your usage of the Site, including your IP address, browser type, pages visited, and the duration of your visit.</li>
							</ul>
						</div>
						...
						<div class="mt-5"  style="background: #f3f3f3;padding:5%;border-radius: 10px !important;">
							...
							<h6><b>3. </b>How We Use Your Information </h6>
							<p><small>We use the collected information for the following purposes: </small></p>

							<ul>
							<small>
								<li>To provide and maintain our website. 
									
								<li>To communicate with you, respond to your inquiries, and provide updates</li>
								<li>To analyse and improve our website's performance and user experience. </li>
						...
						<div class="mt-5"  style="background: #f3f3f3;padding:5%;border-radius: 10px !important;">
							...
							<h6><b>4. </b>Cookies and Similar Technologies</h6>
							<p><small>We use cookies and similar technologies to enhance your browsing experience and collect information about how you use our website. You can manage your cookie preferences through your browser settings.</small></p>
						</div>


						<div class="mt-5"  style="background: #f3f3f3;padding:5%;border-radius: 10px !important;">

							<h6><b>5. </b>Third-Party Links</h6>
							<p><small>Our website may contain links to third-party websites. We are not responsible for the privacy practices or content of these third-party sites. Please review the privacy policies of these websites before providing any personal information.</small></p>
						</div>
