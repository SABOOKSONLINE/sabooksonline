<!-- background layer for the popup banner -->
<div class="popup-banner-bg hide-banner-bg"></div>

<!-- actual banner with close button -->
<div class="popup-banner hide-banner">
    <div class="popup-banner-container">
        <div class="popup-banner-cover">
            <img
                src="/cms-data/book-covers/68513d239ac437.59068354.jpg"
                alt="I Think I'm Depressed"
        ...
        <div class="popup-banner-info">
            ...
            <div class="popup-subtext">
                <p>Read. Reflect. Reach out.</p>
                <p>Let’s break the stigma together.</p>
            </div>
            <div>
                <a href="#" class="btn btn-white">Read Now <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
