...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-NVQBTH7N');
    </script>
    ...
    <script>
        ...
        fbq('init', '1382452533231103');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1382452533231103&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
</head>