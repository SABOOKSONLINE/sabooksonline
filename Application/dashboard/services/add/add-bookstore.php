          ...
          <?php include 'includes/mobile-guide.php';?>
            <div class="col-lg-9">
              <div class="dashboard_title_area">
                <h2>Create Book Store Listing</h2>
                    ...
                    <div class="profile-box d-sm-flex align-items-center mb30">
                        ...
                        <div class="d-flex align-items-center my-3">
                           <!-- <a href="#" class="tag-delt text-thm2"><span class="flaticon-delete text-thm2"></span></a>-->
                            ...
                            <label for="image-upload" class="custom-file-label">Upload Logo <i class="fa fa-file-image"></i></label></a>
                        </div>
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" placeholder="" id="autocomplete" name="store_address" required>
                          <input type="hidden" name="store_province" id="province">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Telephone number</label>
                          <input type="number" class="form-control" placeholder="" name="store_number" required>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Email Address</label>
                          <input type="email" class="form-control" placeholder="" name="store_email" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="mb10">
                          ...
                          <textarea cols="30" rows="6" placeholder="Description" name="store_desc" required></textarea>
                        </div>
                      </div>
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb20">
                                <div class="form-style1">
                                    <label class="heading-color ff-heading fw500 mb10 pt-5" for="store_times">Monday</label>
                                </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                              <div class="mb20">
                                  ...
                                  <div class="bootselect-multiselect">
                                    <input class="form-control" type="time" name="store_times[]" required>
                                  </div>
                                  </div>
                              </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb20">
                                <div class="form-style1">
                                    <label class="heading-color ff-heading fw500 mb10 pt-5" for="Tuesday">Tuesday</label>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb20">
                                <div class="form-style1">
                                    <label class="heading-color ff-heading fw500 mb10 pt-5" for="Wednesday">Wednesday</label>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb20">
                                <div class="form-style1">
                                    <label class="heading-color ff-heading fw500 mb10 pt-5" for="Thursday">Thursday</label>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb20">
                                <div class="form-style1">
                                    <label class="heading-color ff-heading fw500 mb10 pt-5" for="Friday">Friday</label>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb20">
                                <div class="form-style1">
                                    <label class="heading-color ff-heading fw500 mb10 pt-5" for="Saturday">Saturday</label>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="mb20">
                                <div class="form-style1">
                                    <label class="heading-color ff-heading fw500 mb10 pt-5" for="Sunday">Sunday</label>
...
<script src="//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.js"></script>
    ...
    <script>
      ...
      $("#upload_store").on('submit',(function(e) {
        ...
        $.ajax({
          url: "../includes/backend/scripts/functions/store_permissions.php",
          type: "POST",
          data: formData,
          contentType: false,
            cache: false,
