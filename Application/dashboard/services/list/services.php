          ...
          <?php include 'includes/mobile-guide.php';?>
            ...
            <div class="col-lg-3">
              <div class="text-lg-end">
                <a type="submit" class="ud-btn btn-dark default-box-shadow2" id="addservice" href="add-service">Add New Service<i class="fal fa-arrow-right-long"></i></a>
                ...
                <div class="packages_table table-responsive">
                  <table class="table-style3 table at-savesearch">
                    ...
                    <?php
                                ...
                                $sql = "SELECT * FROM services WHERE USERID = '$userkey' ORDER BY ID DESC;";
								...
								if(!$result = mysqli_query($conn, $sql)){
									...
									while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if($service_status == "Service Locked"){
                                                ...
                                                $service_status = '<a href="edit-service?contentid='.$row['ID'].'" class="icon me-2 text-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="flaticon-pencil"></span></a>';
                                            }
                                            ...
                                            <td class="vam"><span class="fz15 fw400"><b>R'.ucwords($row['MINIMUM']).'</b></span></td>
                                            
                                            <td class="vam"><span><b>R'.$row['MAXIMUM'].'</b></span></td>
                                            '.$status.'
                                            <td>
                                              <div class="d-flex">
                                            ...
                                            <!-- Modal -->
														...
														<div class="modal-dialog modal-dialog-centered border-none" style="border: none !important;">
															...
															<div class="modal-body">
																You are about to delete <b>'.ucwords($row['SERVICE']).'</b>, this action cannot be undone once complete. Your book will be removed from this platform instantly.
															</div>
...
<script>
    ...
    $.post("../includes/backend/delete-service.php",
    {
        contentid: contentid
    },
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    tour.addStep({
        id: 'step1',
        text: '<b>Service Listings:</b><hr> You can upload, edit and manage your service listings.',
      ...
      tour.addStep({
        id: 'step10',
        text: '<b>Add Service Listing:</b><hr> In this section you can upload your literary services to SA Books Online',
        attachTo: { element: '#addservice', on: 'bottom' },
        classes: 'example-step-extra-class custom-step-content', // Add custom step class
        buttons: [
            {
                text: 'Skip',
