...
$sql = "SELECT * FROM events WHERE CONTENTID = '$contentid' AND USERID = '$userkey'";
...
while($row = mysqli_fetch_assoc($result)) {
  ...
  $event_time_end = $row['TIMEEND'];
  $event_services = $row['KEYWORDS'];
  $event_id = $row['CONTENTID'];
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" name="event_title" value="<?php echo $title; ?>">
                          <input type="hidden" class="form-control" name="event_id" value="<?php echo $contentid; ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" id="autocomplete" name="event_address" value="<?php echo $venue; ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" name="event_email" value="<?php echo $email; ?>">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Event Telephone</label>
                          <input type="text" class="form-control" name="event_number" value="<?php echo $number; ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="mb10">
                          ...
                          <textarea cols="30" rows="6" placeholder="Description" name="event_desc"><?php echo $desc; ?></textarea>
                        </div>
                      </div>
                          ...
                          <div class="form-style1">
                            ...
                            <div class="bootselect-multiselect">
                              ...
                              <?php
                                 ...
                                 $categoriesArray = explode("|", $event_type);
                                 ...
                                 $selectedCategories = isset($_POST['KEYWORDS']) ? $_POST['KEYWORDS'] : array();
                        ...
                        <div class="mb20">
                          <div class="form-style1 overflow-visible position-relative">
                            ...
                            <div class="bootselect-multiselect">
                              ...
                              <?php
                                 // Assuming $category contains the category data from the database
                                 $categoriesArray = explode("|", $event_services);
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control datepicker" name="dates_start" value="<?php echo $event_date?>">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control datepicker" name="dates_end" value="<?php echo $event_end;?>">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Event Start Time</label>
                          <input type="text" class="form-control timepicker" name="event_start_time" value="<?php echo $event_time;?>">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10 ">Event End Time</label>
                          <input type="text" class="form-control timepicker" name="event_end_time" value="<?php echo $event_time_end;?>">
                        </div>
                      </div>
                        ...
                        <div class="mb20">
                          <div class="form-style1">
                            ...
                            <div class="bootselect-multiselect" style="z-index:1000 !important;">
                              ...
                              <?php
                                 // Assuming $category contains the category data from the database
                                 $categoriesArray = explode("|", $event_duration);
                                 ...
                                 foreach ($availableOptions as $optionValue => $optionLabel) {
                                     $selected = in_array($optionValue, $selectedCategories) ? 'selected' : '';
                                     echo '<option value="' . $optionValue . '" selected>' . $optionLabel . ' Day(s)</option>';
                                 }
              ...
              <div class="ps-widget bgc-white bdrs12 p30 mb30 overflow-hidden position-relative">
                ...
                <div class="d-flex mb30">
                      <div class="gallery-item me-3 bdrs4 overflow-hidden position-relative">
                        <img class="w-100" id="imagePreview" src="<?php echo 'https://sabooksonline.co.za/cms-data/event-covers/'.$cover;?>" style="width: 500px !important"  alt="" style="border: #f3f3f3 solid 4px; border-radius:10px;">
