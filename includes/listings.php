...
<div class=""><hr></div>
<div class="col-lg-12" id="books" style="display: flex !important;justify-content: space-around !important;flex-wrap: wrap !important;">
                                                ...
                                                $result = mysqli_query($conn, $sql);
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) {
														...
														<div class="col-lg-12 d-flex justify-content-start p-0 m-0 p-3 mb-5 main-display" style="background-color: #f3f3f3;border-radius: 10px;">
															...
															<a href="book?q='.strtolower($row['CONTENTID']).'" class="text-dark head-t"><figure>
																	<span class="ribbon off">'.$row['CATEGORY'].'</span>
																	<img src="https://my.sabooksonline.co.za/cms-data/book-covers/'.$row['COVER'].'" data-src="https://my.sabooksonline.co.za/cms-data/book-covers/'.$row['COVER'].'" class="img-fluid lazy" alt="" >
																</figure></a>
															</div>
                                                ...
                                                $result = mysqli_query($conn, $sql);
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) {
														...
														<a href="book?q='.strtolower($row['CONTENTID']).'" class="text-dark head-t">
																<span class="ribbon off">'.$row['CATEGORY'].'</span>
																<img src="https://my.sabooksonline.co.za/cms-data/book-covers/'.$row['COVER'].'" data-src="https://my.sabooksonline.co.za/cms-data/book-covers/'.$row['COVER'].'" class="img-fluid lazy" alt="" width="100px">
															</a>
                                                            <hr>

                                                            <a href="creator?q='.strtolower($row['USERID']).'" class="text-dark head-t" >'.ucwords($row['PUBLISHER']).' <small class="icon_check_alt text-success" style="font-size:12px"></small></a>
