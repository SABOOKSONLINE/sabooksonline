...
$data = array(
    ...
    'return_url' => 'https://my.sabooksonline.co.za/includes/subscriptions/verify_payment',
    'cancel_url' => 'https://my.sabooksonline.co.za/sabo/page-dashboard-plan',
    'notify_url' => 'https://my.sabooksonline.co.za/includes/subscriptions/notify',
    // Buyer details
...
$htmlForm .= '<input class="ud-btn btn-thm mt-2" type="submit" value="Pay With PayFast"><img src="../img/Payfast By Network_dark.svg" width="200px"></form>';
