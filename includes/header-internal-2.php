...
include 'includes/database_connections/sabooks.php';
 ...
 function logPageVisit($conn, $page_url, $user_agent, $referer, $duration, $user_country, $user_ip) {
...
$user_country = $geolocation_data->region_name;
$user_city = $geolocation_data->city;

// Log the visit
logPageVisit($conn, $page_url, $user_agent, $referer, $duration, $user_country, $user_ip);
...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container d-flex justify-content-between">
                <div class="col-lg-2  col-md-6">
                    ...
                    <div id="logo">
                    <a href="index">
                        <img src="https://my.sabooksonline.co.za/img/social.png" width="100" alt="sa books online logo" class="logo">
                    </a>
                </div></a>  
                </div>
        ...
        <?php   
                ...
                if(!isset($_SESSION['ADMIN_ID']) || !isset($_SESSION['ADMIN_PROFILE_IMAGE'])){
                    ...
                    <a href="https://my.sabooksonline.co.za/login" class="btn_1">Login <small class="icon_lock_alt"></small></a>';
                }else {
                    ...
                    <a href="https://my.sabooksonline.co.za/sabo/page-dashboard" class="btn_1 btn-sm">Dashboard <small class="icon_lock_alt"></small></a>';
                }
