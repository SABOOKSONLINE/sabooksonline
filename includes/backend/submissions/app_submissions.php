...
$uniqueMp3Name = uniqid() . "_" . $mp3FileName;
$mp3FilePath = $uploadDirectory . $uniqueMp3Name;
move_uploaded_file($mp3File['tmp_name'], $mp3FilePath);

// Handle Cover Image
$coverImage = $_FILES['cover'];
$coverImageName = $coverImage['name'];
$uniqueCoverName = uniqid() . "_" . $coverImageName;
$coverImagePath = $uploadDirectory . $uniqueCoverName;
...
$stmt->bind_param("ssssssss", $userkey, $contentid, $uniqueMp3Name, $uniqueCoverName, $current_time, $type, $status, $uniqueKey);
