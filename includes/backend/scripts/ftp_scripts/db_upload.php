...
if($domain_type == 'main'){
    $remoteFilePath = '/httpdocs/site/includes/db.php'; // Replace with the remote file path in Plesk
    $ftpUsername = $customerUsername;
    $ftpPassword = $customerPassword;
    ...
    $remoteFilePath = "/$userkey/includes/db.php"; // Remote path for extracted files
}


$localFilePath = 'ftp_scripts/db.php';   // Replace with the local file path
