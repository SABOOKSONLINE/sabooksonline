        ...
        if ($stmt->execute()) {
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    echo "<script>Swal.fire({position: 'top-end',icon: 'success',title: 'Your data has been deleted!',showConfirmButton: false,timer: 6000});setInterval(function(){window.location.replace('page-dashboard-websites');},3000);</script>";
                } else {
                    echo "<script>Swal.fire({position: 'top-end',icon: 'danger',title: 'Your emails could not be deleted!',showConfirmButton: false,timer: 6000});setInterval(function(){window.location.replace('page-dashboard-websites');},3000);</script>";
                }
            } else {
                echo "Error preparing statement for emails deletion: " . $mysqli->error;
            }
        } else {
            echo "<script>Swal.fire({position: 'top-end',icon: 'danger',title: 'Your website with domain could not be deleted!',showConfirmButton: false,timer: 6000});setInterval(function(){window.location.replace('page-dashboard-websites');},3000);</script>";
        }
    } else {
