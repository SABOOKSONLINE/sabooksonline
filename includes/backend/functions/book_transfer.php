    ...
    $sourceTable = "posts";
    $sqlSelect = "SELECT ID, CATEGORY, TYPE, TITLE, RETAILPRICE, DESCRIPTION, COVER, ISBN, STOCK FROM $sourceTable WHERE USERID = '$userid' AND STATUS = 'Active'";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $sqlInsertOrUpdate = "INSERT INTO $destinationTable (product_id, product_cat, product_brand, product_title, product_price, product_desc, product_image, product_keywords, product_stock) VALUES ($columnValues) ON DUPLICATE KEY UPDATE product_cat = VALUES(product_cat), product_brand = VALUES(product_brand), product_title = VALUES(product_title), product_price = VALUES(product_price), product_desc = VALUES(product_desc), product_image = VALUES(product_image), product_keywords = VALUES(product_keywords), product_stock = VALUES(product_stock)";
