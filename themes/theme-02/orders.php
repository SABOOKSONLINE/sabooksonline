                ...
                <div class="col-md-12 col-sm-12 ol-lg-12">
                    <form action="#">
                        ...
                        <?php
                                                ...
                                                $sql = "SELECT * FROM product_order WHERE user_id = '$userid' AND invoice_number = '$user_invoice'";
                                                ...
                                                $result = mysqli_query($con, $sql);
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <td class="product-thumbnail"><a href="#"><img
                                                                src="https://my.sabooksonline.co.za/cms-data/book-covers/'.$row['product_image'].'" alt="product img" width="50px"></a></td>
                                                        <td class="product-name"><a href="#">'.$row['product_title'].'</a></td>
                                                        <td class="product-price"><span class="amount">R'.$row['product_price'].'</span></td>
                                                        <td class="product-quantity"><b>'.$row['product_quantity'].'</b></td>
