  ...
  <div class="container">
    ...
    <?php
        ...
        if(!isset($_GET['invoice'])){
            header("Location: ../../my-account?accessdenied");
        } else {

            $invoice_number = $_GET['invoice'];

            $sql = "SELECT * FROM product_order WHERE invoice_number = '$invoice_number'";

            $data = mysqli_fetch_assoc(mysqli_query($conn, $sql));

            $status_invoice = $data['product_current'];

            
            if($status_invoice != 'COMPLETED'){
        ...
        ?>
            ...
            <div class="row">
                ...
                <div>
                    <img src="https://my.sabooksonline.co.za/img/social.png" width="120px">
                </div>
                <div class="col-12">
                    <div class="invoice-title pt-4">
                        <h3>Invoice <?php echo $status_in; ?></h3><h3 class="float-right">Order #<?php echo $invoice_number;?></h3>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <address>
                                <strong>Payment Status: <?php echo $status_in;?></strong><br><br>
                                <?php echo $status_invoice;?>
                            </address>
                        </div>
                        ...
                        <h5><strong>Order summary</strong></h5>
                            <div class="table-responsive">
                                <table class="table table-condensed">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Subscription - <?php echo $data['INVOICE_SUBSCRIPTION'];?> @ R<?php echo $data['INVOICE_AMOUNT'];?></td>
                                            <td class="text-center">R<?php echo $data['INVOICE_AMOUNT'];?></td>
                                            <td class="text-right">R<?php echo $data['INVOICE_AMOUNT'];?></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="thick-line text-right">R<?php echo $data['INVOICE_AMOUNT'];?></td>
                                        </tr>
